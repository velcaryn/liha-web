...
const faqs = [
  {
    ...
    answer: 'Pure palm jaggery stays fresh for 9 to 12 months. Store it in an airtight glass, clay, or stainless steel container in a cool, dry place. Avoid using wet spoons and keep it away from direct moisture to preserve its natural aroma and texture.'
  },
  {
    question: 'How does shipping work and what are the delivery timelines?',
    answer: 'We ship across India. All orders are carefully packed in food-grade, moisture-resistant packaging and dispatched within 24 hours. Delivery typically takes 2 to 4 business days for South India and 3 to 6 business days for the rest of India. You will receive a tracking link on WhatsApp once dispatched.'
  },
  {
    question: 'Will adding Karuppati to hot tea or filter coffee curdle the milk?',
    answer: 'Pure, authentic palm jaggery does not curdle milk. For best flavor and traditional richness, add Karuppati after brewing your tea or coffee and stir gently before serving.'
  },
  {
  ...
  return (
    <section id="faq" className="faq-section">
      ...
      <style>{`
        ...
        .faq-question-btn {
          width: 100%;
          min-height: 56px; /* Touch-friendly mobile target */
